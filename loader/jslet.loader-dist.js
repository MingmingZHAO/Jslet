...
//css
     {name: 'jslet-style', src: '../dist/resources/{theme}/jslet-all.css', calcBaseUri: true },
//message for i18n
    { name: 'locale', src: '../dist/locale/{lang}/locale.js', calcBaseUri: true },
//lib
	{name: 'jquery', src: '../dist/lib/jquery-1.8.3.min.js', calcBaseUri: true },
	{name: 'jsonlib', src: '../dist/lib/jquery.json-2.3.js', deps: 'jquery', calcBaseUri: true },
    {name: 'swfobject', src: '../dist/lib/swfobject.js', calcBaseUri: true },
//jslet
  {name: 'jslet', src: '../dist/jslet-2.0.min.js', deps: 'locale,jquery,jsonlib,jslet-style,swfobject', calcBaseUri: true },
 ];
