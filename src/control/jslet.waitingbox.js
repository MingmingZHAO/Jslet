...
jslet.ui.WaitingBox = function (container, overlayColor, tipsAtNewLine) {
    var overlayColor = null;// overlayColor ? overlayColor : 'CCCCCC';
    var overlay = new jslet.ui.OverlayPanel(container);
    var s = '<div class="jl-waitingbox"><b class="jl-waitingbox-icon"></b>'; //<img src = '" + jslet.rootUri + jslet.WaitingBox.IMGURL + "' alt='' />";
//    if (tipsAtNewLine)
//        s += "<div></div></div>";
//    else
    ...
    this.show = function (tips) {
        ...
        var box = p.firstChild;
        var tipPanel = box.childNodes[1];
...
jslet.ui.WaitingBox.IMGURL = 'resources/' + (jslet.theme ? jslet.theme : 'default') + '/images/waiting/waiting.gif';
