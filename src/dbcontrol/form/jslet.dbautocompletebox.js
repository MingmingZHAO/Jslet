 ...
 * </code></pre>
 */
jslet.ui.DBAutoCompleteBox = jslet.Class.create(jslet.ui.DBText, {
	/**
	 * @override
	 */
    ...
    invokePopup: function () {
        ...
        //        Z._timeoutHandler = setTimeout('_jslet_temp_var.jslet.populate(_jslet_temp_var.value);delete _jslet_temp_var', delayTime);
...
jslet.ui.register('DBAutoCompleteBox', jslet.ui.DBAutoCompleteBox);
jslet.ui.DBAutoCompleteBox.htmlTemplate = '<input type="text"></input>';
