...
jslet.ui.DBRating = jslet.Class.create(jslet.ui.DBControl, {
    ...
    initialize: function ($super, el, params) {
        ...
        Z.itemCount = 5;
        /**
         * {Integer} You can use it to split the 'Star' sign to express decimal like: 1.5, 1.25.
    ...
    _mouseDown: function dodown(event) {
        ...
        Z.dataset.fieldValue(Z.field, Z.value);
		Z._innerRefreshControl();
    },
	 ...
	 */
    renderAll: function () {
        var Z = this, f = Z.dataset.getField(Z.field);
        if (Z.readOnly == undefined)
            Z.readOnly = !f.enabled() || f.readOnly();
